        ...
        <div className="flex flex-col lg:flex-row gap-12 mb-12">
          ...
          <div className="lg:w-1/3 flex flex-col items-start gap-4">
            ...
            <div className="flex items-center gap-4 mt-2">
              <a href="https://reddit.com/r/wbjee" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#FF4500] transition-colors" aria-label="Reddit">
              ...
              <a href="https://discord.gg/pTTKPYryDp" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#5865F2] transition-colors" aria-label="Discord">
