...
async function findRankForProgram(
  ...
  console.log(`Searching for rank for ${program} at ${college}...`);
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div>
              ...
              <select id="year-select" value={selectedYear} onChange={(e) => setSelectedYear(Number(e.target.value))} className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md dark:bg-gray-800 dark:border-gray-600">
            ...
            <div>
              ...
              <select id="seat-type-select" value={selectedSeatType} onChange={(e) => setSelectedSeatType(e.target.value)} className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md dark:bg-gray-800 dark:border-gray-600">
            ...
            <div>
              ...
              <select id="round-select" value={selectedRound} onChange={(e) => setSelectedRound(e.target.value)} className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md dark:bg-gray-800 dark:border-gray-600">
            ...
            <div>
              ...
              <select id="category-select" value={selectedCategory} onChange={(e) => setSelectedCategory(e.target.value)} className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md dark:bg-gray-800 dark:border-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-200 dark:border-gray-700">
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400"
              >
            ...
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md disabled:bg-gray-200 dark:disabled:bg-gray-700 dark:bg-gray-800 dark:border-gray-600"
              >
          ...
          <div>
            <button
              ...
              className="w-full inline-flex justify-center items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-300 dark:disabled:bg-blue-800"
            >
              {isLoading ? "Searching..." : "Find Required Rank"}
            </button>
          </div>
        </div>

        {error && <div className="mt-6 p-4 bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-300 rounded-md">{error}</div>}

        {result && !isLoading && (
          <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg shadow">
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
              Rank for {selectedProgram} at {selectedCollege}
            </h3>
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 text-center">
              <div className="p-4 bg-green-100 dark:bg-green-900/30 rounded">
                <p className="text-sm text-gray-600 dark:text-gray-300">Opening Rank</p>
                <p className="text-2xl font-bold text-green-800 dark:text-green-300">{result.openingRank ?? 'N/A'}</p>
              </div>
              <div className="p-4 bg-yellow-100 dark:bg-yellow-900/30 rounded">
                <p className="text-sm text-gray-600 dark:text-gray-300">Closing Rank</p>
                <p className="text-2xl font-bold text-yellow-800 dark:text-yellow-300">{result.closingRank ?? 'N/A'}</p>
              </div>
            </div>
          </div>
        )}
