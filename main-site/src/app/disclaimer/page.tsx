export default function DisclaimerPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <h4 className="text-lg font-bold mt-6 mb-2">3. Rank and Admission Predictions</h4>
      <p className="mb-6">The Site may include tools, articles, or user discussions that provide predictions regarding college admissions, cutoff ranks, or scores for the WBJEE. These predictions are based purely on <strong>historical data, past trends, and community-sourced information.</strong> This information is speculative in nature and is provided for reference purposes only. <strong>It is NOT a guarantee of admission</strong> or a guarantee of any specific outcome. Admission cutoffs and outcomes are subject to change each year based on numerous factors, including the number of applicants, the difficulty of the examination, and changes in college admission policies. Users should treat these predictions as educated estimates and are advised to consult official sources and make their own informed decisions during the counseling process.</p>

      <h4 className="text-lg font-bold mt-6 mb-2">4. User-Generated Content</h4>
      <p className="mb-6">This Site may include content and comments posted by users of the community. The views and opinions expressed in this user-generated content are those of the authors and do not necessarily reflect our official policy or position. We are not responsible for any user-generated content and do not guarantee its accuracy or reliability.</p>

      <h4 className="text-lg font-bold mt-6 mb-2">5. External Links</h4>
      <p className="mb-6">The Site may contain links to other websites or content belonging to or originating from third parties. Such external links are not investigated, monitored, or checked for accuracy, adequacy, validity, reliability, availability, or completeness by us. We do not warrant, endorse, guarantee, or assume responsibility for the accuracy or reliability of any information offered by third-party websites linked through the Site.</p>

      <p className="mt-8"><strong>Last Updated:</strong> August 17, 2025</p>
