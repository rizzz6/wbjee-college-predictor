...
import { LinkIcon, DocumentTextIcon, WarningOutlineIcon, CheckmarkCircleIcon } from '@sanity/icons'
...
export const collegeType = defineType({
  ...
  preview: {
    ...
    prepare({ title, subtitle: _subtitle, type, isVisible, media, lastSyncedAt, highlights, estYear, description, website, fees, feeStructure, placements, coverImage, detailsIdentifier }) {
