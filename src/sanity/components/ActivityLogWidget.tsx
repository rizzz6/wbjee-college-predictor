...
export function ActivityLogWidget() {
    ...
    const isNewlyCreated = (item: ActivityItem): boolean => {
    ...
    const stats = {
        ...
        created: activities.filter((a: any) => a.activityType === 'created').length,
        updated: activities.filter((a: any) => a.activityType === 'updated').length
    }
