...
import type { CollegeDetailDoc, CollegeDoc, PlacementStats, FeeStats, AboutParagraphs, TableRow } from './types'
import { Download, Upload } from 'lucide-react'
import { apiVersion } from '../env'

export default function CollegeDetailReferenceInput(props: any) {
    ...
    highlights,
        ...
        description
            ...
            const aboutObj: any = {}
            bodyBlocks.forEach((block: any, index: number) => {
                ...
                <Card padding={3} radius={2} shadow={1} tone="primary">
                    <Stack space={3}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                            ...
                            {lastSyncedAt && (() => {
                                const isRecent = (Date.now() - new Date(lastSyncedAt).getTime()) < 86400000
                                return (
