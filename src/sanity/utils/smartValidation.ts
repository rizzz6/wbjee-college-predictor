 ...
 * Validate a single college document
 */
export function validateCollege(input: Record<string, unknown>): ValidationResult {
    const college = input as unknown as CollegeData
